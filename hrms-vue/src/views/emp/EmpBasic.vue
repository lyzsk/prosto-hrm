    ...
    data() {
        return {
            ...
            rules: {
                ...
                nationId: [
                    { required: true, message: "请输入您组", trigger: "blur" },
                ],
                nativePlace: [
    ...
    methods: {
        ...
        deleteEmp(data) {
            this.$confirm(
                ...
                .then(() => {
                    this.deleteRequest("/employee/basic/" + data.id).then(
                        (resp) => {
                            if (resp) {
                                this.initEmps();
                            }
        ...
        initData() {
            if (!window.sessionStorage.getItem("nations")) {
                ...
                this.nations = JSON.parse(
                    window.sessionStorage.getItem("nations")
                );
            }
            ...
            if (!window.sessionStorage.getItem("deps")) {
                ...
                this.allDeps = JSON.parse(
                    window.sessionStorage.getItem("deps")
                );
            }
        },
        ...
        initEmps(type) {
            this.loading = true;
            let url =
                "/employee/basic/?page=" + this.page + "&size=" + this.size;
