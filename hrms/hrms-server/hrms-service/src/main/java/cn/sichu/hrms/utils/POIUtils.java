...
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<Employee> list) {
        ...
        //文档管理员
        docInfo.setManager("lyzsk");
        //设置公司信息
        docInfo.setCompany("www.lyzsk.org");
        //4. 获取文档摘要信息
        SummaryInformation summInfo = workbook.getSummaryInformation();
        //文档标题
        summInfo.setTitle("员工信息表");
        //文档作者
        summInfo.setAuthor("lyzsk");
        // 文档备注
        summInfo.setComments("本文档由 lyzsk 提供");
        //5. 创建样式
        //创建标题行的样式
    ...
    public static List<Employee> excel2Employee(MultipartFile file, List<Nation> allNations,
        List<Politicsstatus> allPoliticsstatus, List<Department> allDepartments, List<Position> allPositions,
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 8:
                                        ...
                                        break;
                                    case 9:
                                        int politicstatusIndex =
                                            allPoliticsstatus.indexOf(new Politicsstatus(cellValue));
