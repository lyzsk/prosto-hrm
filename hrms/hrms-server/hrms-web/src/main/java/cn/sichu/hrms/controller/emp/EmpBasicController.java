package cn.sichu.hrms.controller.emp;

import cn.sichu.hrms.model.*;
import cn.sichu.hrms.service.*;
import cn.sichu.hrms.utils.POIUtils;
...
public class EmpBasicController {
    ...
    public RespBean importData(MultipartFile file) throws IOException {
        List<Employee> list =
            POIUtils.excel2Employee(file, nationService.getAllNations(), politicsstatusService.getAllPoliticsstatus(),
