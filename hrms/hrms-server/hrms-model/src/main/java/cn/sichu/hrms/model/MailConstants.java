...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "sichu.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "sichu.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "sichu.mail.routing.key";
}
